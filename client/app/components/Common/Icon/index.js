...
import {
  ...
  ArrowLeft,
  X
} from 'lucide-react/dist/cjs/lucide-react.cjs';
...
const BarsIcon = ({ className = '', size = 22 }) => (
  <Menu className={className} size={size} strokeWidth={1.5} aria-hidden='true' />
);

const CloseIcon = ({ className = '', size = 18 }) => (
  <X className={className} size={size} strokeWidth={1.5} aria-hidden='true' />
);

const XIcon = ({ className = '', size = 20 }) => (
  <X className={className} size={size} strokeWidth={2} aria-hidden='true' />
);

const ArrowBackIcon = ({ className = '', size = 20 }) => (
  <ArrowLeft className={className} size={size} strokeWidth={2} aria-hidden='true' />
);

const HeartOutlineIcon = ({ className = '', size = 24, color = 'currentColor' }) => (
  <Heart className={className} size={size} strokeWidth={2} stroke={color} fill='none' aria-hidden='true' />
);

const UserCircleIcon = ({ className = '', size = 24, color = 'currentColor' }) => (
  <User className={className} size={size} strokeWidth={2} stroke={color} fill='none' aria-hidden='true' />
);

const CheckIcon = ({ className = '', size = 24, color = 'currentColor' }) => (
  <Check className={className} size={size} strokeWidth={2} stroke={color} aria-hidden='true' />
);

const RefreshIcon = ({ className = '', size = 20 }) => (
  <RefreshCw className={className} size={size} strokeWidth={2} aria-hidden='true' />
);

const TrashIcon = ({ className = '', size = 20 }) => (
  <Trash2 className={className} size={size} strokeWidth={2} aria-hidden='true' />
);
