...
const HeartOutlineIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => {
  return (
    <svg
      className={`${className} heart-outline-icon`}
      xmlns='http://www.w3.org/2000/svg'
      width={width}
      height={height}
      viewBox='0 0 24 24'
...
const UserCircleIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => {
  return (
    <svg
      className={`${className} user-circle-icon`}
      xmlns='http://www.w3.org/2000/svg'
      width={width}
      height={height}
      viewBox='0 0 24 24'
